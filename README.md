...
# 1. Dipertemuan kali ini akan saya akan mempelajari apa itu javascript pada html, seperti penempatan javascript pada html di internal atau pun eksternal JavaScript
...
```
Ini adalah program seleksi kondisi dari if else disitu if nya jika nilai lebih sama dengan 60 berarti lulus dan else nya jika dibawah 60 berati tidak lulus, sementara saya memberi nilai 90 yang berarti hasil nya adalah lulus

![menambahkan_gambar](img/7.png)
Dan jika nilai diaatas 60 Berarti mahasisswa itu Lulus
![menambahakan_gambar](img/8.png)
...
![menambahkan_gambar](img/8%20asli.png)

Penggunaan operator switch untuk seleksi kondisi, disini saya menulis program switch case sebagai seleksi kondisi dengan memasukan angka 5 sebagai angka seleksi nya kemudian output nya akan keluar argument bilangan lainnya dan ini adalah Contoh Tampilannya.

![menambahkan_gambar](img/8%20lagi.png)
...
```
Disini menggunakan form button dengan function javascript dan html form button hasil nya adalah seperti contoh gambar dibawah, saya memilih warna Biru dan teks Hitam
...
```
Disini menggunakan HTML DOM dengan input type checkbox
Berikut pula Contoh Tampilan.
![menambah_gambar](img/11.png)
...
Selanjutnya Masukan Contoh CSS berikut
```
body {
    background: #585858;
  ...
  .tombol {
   ...
   .tombol:hover{
      background-color: rgb(89, 243, 179);
  }
```
Berikut Contoh Tampilannya.


![menambahkan_gambar](img/pertanyaan.png)
